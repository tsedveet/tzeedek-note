...
import { fetchSalt, registerVault, loginVault, VaultData } from '@/lib/api-client';
...
export default function AuthScreen({ theme, setTheme, onAuthSuccess }: AuthScreenProps) {
